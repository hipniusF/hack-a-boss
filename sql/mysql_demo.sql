-- Thanks to http://justinsomnia.org/2009/04/the-employee-and-department-tables-for-mysql/

-- Run as demo user: mysql -u demo -ppassword < mysql_employee_department.sql
